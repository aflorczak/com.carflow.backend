...
public class Car {
    ...
    public Car(Integer id, Boolean archive, String branchSlug, String brand, String model, Integer mileage, FuelType fuel, Integer numberOfSeats, Integer numberOfDoors, BodyType bodyType, CarSegment segment, String VIN, String registrationNumber, LocalDate technicalExaminationDate, LocalDate endDateOfInsurance, String damagedDescription, String damagedPhotosUrls) {
        this.id = id;
