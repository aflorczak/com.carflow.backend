package com.carflow.backend.modules.carModule.infrastructure.boundary.in.api.v_0_0_1.entities;
...
public class CarDto {
    ...
    public CarDto(Integer id, Boolean archive, String branchSlug, String brand, String model, Integer mileage, FuelType fuel, Integer numberOfSeats, Integer numberOfDoors, String bodyType, String segment, String VIN, String registrationNumber, String technicalExaminationDate, String endDateOfInsurance, String damagedDescription, String damagedPhotosUrls) {
        this.id = id;
