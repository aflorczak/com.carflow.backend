package com.carflow.backend.modules.carModule.domain.models;
...
public class Car {
    ...
    public Car(Integer id, Boolean archive, String branchSlug, String brand, String model, Integer mileage, FuelType fuel, Integer numberOfSeats, Integer numberOfDoors, String bodyType, String segment, String VIN, String registrationNumber, String technicalExaminationDate, String endDateOfInsurance, String damagedDescription, String damagedPhotosUrls) {
        this.id = id;
