...
public class CarStorageMemory implements CarStorage {
    ...
    public CarStorageMemory() {
        createNewCar(new Car(-1, false, "Peugeot", "308 CC", 16524, "Pb95", 4, 3, "HATCHBACK", "D", "VF3WA5FWC34021008", "D1 SMOK", "19-05-2023", "19-05-2023", null, null));
        createNewCar(new Car(-1, false,"SKODA", "FABIA", 16524, "PB95", 4, 3, "COMBI", "B", "VF3WA5FWC34021008", "KR 4F514", "19-05-2023", "19-05-2023", null, null));
        createNewCar(new Car(-1, false,"SKODA", "OCTAVIA", 16524, "DIESEL", 4, 3, "COMBI", "D", "VF3WA5FWC34021008", "KR 5D74VB", "19-05-2023", "19-05-2023", null, null));
    }
    ...
    public Car createNewCar(Car car) {
        ...
        cars.put(id, new Car(nextId, false, car.getBrand(), car.getModel(), car.getMileage(), car.getFuel(), car.getNumberOfSeats(), car.getNumberOfDoors(), car.getBodyType(), car.getSegment(), car.getVIN(), car.getRegistrationNumber(), car.getTechnicalExaminationDate(), car.getEndDateOfInsurance(), car.getDamagedDescription(), car.getDamagedPhotosUrls()));
